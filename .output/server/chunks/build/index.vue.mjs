...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "px-[2.5rem] py-[5rem] flex justify-between items-center relative z-10 container lg:w-[70rem] lg:pt-[9rem]" }, _attrs))} data-v-d990ea49><h1 class="uppercase text-light-gray-100 font-w700 text-[2.6rem] tracking-[1rem] leading-[0] pt-[.7rem] lg:text-[4rem]" data-v-d990ea49> todo </h1>`);
      if (unref(store).isLight) {
        _push(`<button data-v-d990ea49><img${ssrRenderAttr("src", unref(sun))} alt="light theme&#39;" class="${ssrRenderClass(unref(themeIconStyles))}" data-v-d990ea49></button>`);
      } else {
        _push(`<button data-v-d990ea49><img${ssrRenderAttr("src", unref(moon))} alt="dark theme" class="${ssrRenderClass(unref(themeIconStyles))}" data-v-d990ea49></button>`);
      }
      _push(`</header>`);
    };
  }
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-d990ea49"]]);
